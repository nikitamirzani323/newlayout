<script>
    ...
    export let adminrule_idcompany = "";
    ...
    async function SaveTransaksi(name) {
        const res = await fetch("/api/companyadminrulesave", {
            ...
            body: JSON.stringify({
                sdata: sData,
                page: "ADMINRULE-SAVE",
                companyadminrule_id: adminrule_idadmin,
                companyadminrule_idcompany: adminrule_idcompany,
                companyadminrule_nmrule: adminrule_nmrule,
                companyadminrule_rule: adminrule_rule_field.toString(),
            }),
        });
            ...
            <div class="card" style="border-radius: 0px;margin-top:10px;">
                ...
                <div class="card-body" style="height:400px;">
                    <div class="mb-3">
                        ...
                        <input
                            bind:value={adminrule_idcompany}
                            type="text"
                            maxlength="70"
                            disabled
                            class="form-control"
